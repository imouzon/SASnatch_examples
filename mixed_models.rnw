...
%  Last Modified: Mon Apr 28 02:14:26 2014
%  Created By:
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%-- Set parent file
...
<<procPlot, fig.width=5, fig.height=5, out.width='.5\maxwidth', echo=TRUE>>=
...
<<SASmixed, eval=FALSE, echo=TRUE, cache=FALSE, include = TRUE>>=
